...
# Load segments.json
root_dir = Path.cwd().parent.parent  # simulate ROOT = "../../"
segment_path = root_dir / "data" / "transcripts" / "segments.json"
...
import ace_tools as tools; tools.display_dataframe_to_user(name="TF-IDF Top Matches", dataframe=pd.DataFrame(tfidf_results, columns=["Start Time (s)", "Transcript", "Score"]))
tools.display_dataframe_to_user(name="BM25 Top Matches", dataframe=pd.DataFrame(bm25_results, columns=["Start Time (s)", "Transcript", "Score"]))

...
if __name__ == "__main__":
    ...
    if text_score >= SIM_THRESHOLD and text_score >= image_score:
        print(f"\n Transcript Match:")
        print(f"[{text_result[1]:.2f}s] {text_result[0]}  [score={text_score:.4f}]")

    if image_score >= SIM_THRESHOLD and image_score > text_score:
        print(f"\n Image Match:")
    ...
    if text_score < SIM_THRESHOLD and image_score < SIM_THRESHOLD:
        print(" No confident match in either modality.")
